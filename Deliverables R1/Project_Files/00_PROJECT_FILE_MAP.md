...
## Current alignment files

- `SOURCE_OF_TRUTH_INDEX.md` — first file to read before implementation or review.
- `PROJECT_STATUS_CURRENT.md` — current accepted baseline and next dashboard update.
- `M21_STREAMLIT_DASHBOARD_V2_WORKFLOW_SPEC.md` — active next-work spec for Dashboard V2 Update.
- `docs/TODO_ROADMAP.md` — current roadmap.
- `docs/DECISIONS_LOG.md` — current architecture decisions.
